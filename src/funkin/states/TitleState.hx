...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (Options.profile.flashing == null && !FlashingState.leftState)
		{
	...
	private function startIntro():Void
	{
		...
		logoBl.antialiasing = Options.profile.globalAntialiasing;
		...
		titleText.antialiasing = Options.profile.globalAntialiasing;
		...
		ngSpr.antialiasing = Options.profile.globalAntialiasing;
		add(ngSpr);
	...
	private function skipIntro():Void
	{
		if (!skippedIntro)
		{
			...
			else // Default! Edit this one!!
			{
				...
				FlxTween.completeTweensOf(FlxG.sound.music, ['fadeTween']); // Make the fade-in complete early
			}
			skippedIntro = true;
		}
	}
