...
import funkin.ui.HitGraph;
import funkin.ui.OFLSprite;
...
class ResultsSubState extends FlxSubState
{
	...
	override public function create():Void
	{
		...
		contText = new FlxText(FlxG.width - 475, FlxG.height + 50, 0, 'Press ${Options.profile.controllerMode ? 'A' : 'ENTER'} to continue.', 28);
