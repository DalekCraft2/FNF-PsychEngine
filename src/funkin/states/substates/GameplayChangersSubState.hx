...
import funkin.ui.AttachedText;
import funkin.ui.Checkbox;

using StringTools;

// This functions more like a "Quick Options Menu" now.
// TODO Either replace some of the code in this with code from OptionsSubState, or get rid of the class entirely in favor of OptionsSubState
class GameplayChangersSubState extends MusicBeatSubState implements ListMenu
{
	...
	private function getOptions():Void
	{
		...
		// TODO Here's that option what I still want to find a way to implement
		/*
...
class GameplayOption
{
	...
	{
		return Reflect.field(Options.profile, variable);
	}

	public function setValue(value:Any):Void
	{
		Reflect.setField(Options.profile, variable, value);
	}
