...
class LoadReplayState extends MusicBeatState implements ListMenu
{
	...
	override public function create():Void
	{
		...
		controlsStrings = Paths.fileSystem.readDirectory(Path.join(['assets', 'replays']));
		...
		menuBG.updateHitbox();
		menuBG.screenCenter();
		menuBG.antialiasing = Options.profile.globalAntialiasing;
		add(menuBG);
