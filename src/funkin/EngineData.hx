...
class EngineData
{
	// TODO Use FlxVersion for this (Possibly not; the version has a letter which doesn't fit into the FlxVersion format (Just change the version to something else, dingus; this is your own engine))
	...
	// TODO Make a separate class for accessing the save data fields, like OptionProfile
