...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		stageFront.antialiasing = Options.save.data.globalAntialiasing;
		add(stageFront);
		...
		if (!Options.save.data.lowQuality)
		{
			...
			stageLight.antialiasing = Options.save.data.globalAntialiasing;
			add(stageLight);
			...
			stageLight2.antialiasing = Options.save.data.globalAntialiasing;
			...
			stageCurtains.antialiasing = Options.save.data.globalAntialiasing;
			add(stageCurtains);
		}
