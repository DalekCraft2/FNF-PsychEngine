...
class ResultsSubState extends FlxSubState
{
	...
	override function create()
	{
		...
		var sicks = PlayState.isStoryMode ? PlayState.campaignSicks : PlayState.instance.sicks;
		var goods = PlayState.isStoryMode ? PlayState.campaignGoods : PlayState.instance.goods;
		var bads = PlayState.isStoryMode ? PlayState.campaignBads : PlayState.instance.bads;
		var shits = PlayState.isStoryMode ? PlayState.campaignShits : PlayState.instance.shits;
		...
		var sicks = CoolUtil.truncateFloat(PlayState.instance.sicks / PlayState.instance.goods, 1);
		var goods = CoolUtil.truncateFloat(PlayState.instance.goods / PlayState.instance.bads, 1);
