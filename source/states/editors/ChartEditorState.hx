...
import EventType.EditorEventType;
...
import states.substates.PromptSubState;
...
class ChartEditorState extends MusicBeatState
{
	...
	override public function update(elapsed:Float):Void
	{
		...
		// TODO Figure out what causes the mouse to spontaneously disappear in some editors
