	...
	function reloadTexts()
	{
		for (i in 0...dumbTexts.length)
		{
			switch(i)
			{
				...
				case 1: dumbTexts.members[i].text = '[' + OptionUtils.options.comboOffset[0] + ', ' + OptionUtils.options.comboOffset[1] + ']';
				case 2: dumbTexts.members[i].text = 'Numbers Offset:';
				case 3: dumbTexts.members[i].text = '[' + OptionUtils.options.comboOffset[2] + ', ' + OptionUtils.options.comboOffset[3] + ']';
			}
		}
	}
